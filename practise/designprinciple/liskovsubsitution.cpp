...
/*
subclass should subsitute base class  , and not change the behaviour 
Subclasses must honor the expected behavior of the base class.
LSP is about substitution (object behavior).
*/
